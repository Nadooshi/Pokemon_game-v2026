...
function sc_ai_new_target() {
	...
	if global.sc_does_exist(target, undefined, "'target' in ai_new_target") {
...
function sc_ai_follow_target() {
	if not global.sc_does_exist(target, undefined, "'target' in sc_ai_follow_target") {
		sc_player_stop_set()
...
function sc_ai_target_group() {
	if not global.sc_does_exist(target, undefined, "'target' in sc_ai_target_group") {
		sc_player_stop_set()
		sc_set_behaviour(sc_player_stop_set)
		return false
	}
...
function sc_ai_hit_target() {
	if not global.sc_does_exist(target, undefined, "'target' in sc_ai_hit_target") {
		sc_player_stop_set()
		sc_set_behaviour(sc_player_stop_set)
...
function sc_ai_wait_power() {
	if not global.sc_does_exist(target, undefined, "'target' in sc_ai_wait_power") {
		sc_set_behaviour(sc_player_stop_set)
		return false
	}
	sc_player_stop_set()
