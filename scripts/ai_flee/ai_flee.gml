function sc_ai_set_flee() {
	...
	if global.sc_does_exist(target, undefined, "'target' in sc_ai_set_flee")
...
function sc_ai_flee() {
	if global.sc_does_exist(target, undefined, "'target' in sc_ai_flee") {
		tgX = target.x
		tgY = target.y
...
function sc_ai_retreat_start() {
	...
	if global.sc_does_exist(_enemy, undefined, "'_enemy' in sc_ai_retreat_start") {
